...
import com.xinyi.touhang.adapter.BankAdapter;
...
public class BusinessInner3ragment extends BaseFragment {
     ...
     * @return A new instance of fragment BusinessInner3ragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BusinessInner3ragment newInstance(String param1, String param2) {
        BusinessInner3ragment fragment = new BusinessInner3ragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_business_inner3ragment, container, false);
    ...
    public void initDatas() {
        ...
        OkGo.<String>post(AppUrls.BankSearchUrl)
                        ...
                        try {
                            ...
                            if (js.getBoolean("result")) {
                                ...
                                adapter.addDatas(JsonUtils.ArrayToList(js.getJSONArray("data"),
                                        new String[]{
                                                "id", "name", "direction", "rates", "amount", "time_limit",
                                                "description", "rish", "baoben", "contact", "confirm",
                                                "top", "type","yellow"
                                        }));
                            } else {
