...
public class IpoAdapter extends RecyclerView.Adapter<IpoAdapter.ViewHolder> {
    ...
    private String[] titles = new String[]{"法律", "财务"};
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.topLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(context, IpoListActivity.class);
                it.putExtra(IpoListActivity.TITLE, "IPO·" + titles[position]);
                if (position == 0) {
                    it.putExtra(IpoListActivity.TYPE, "1");
                } else {
                    it.putExtra(IpoListActivity.TYPE, "2");
                }
