...
public class ForumCommentAdapter extends BaseAdapter<ForumCommentAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.forum_comment_item, parent, false);
    ...
    private void doThumbsUp(final int motifyPosition, String comment_id, TextView userThumbNumTv) {
        ...
        OkGo.<String>post(AppUrls.ForumGood_clickUrl)
